...
public class EseCalendarTest extends UnitTest {
	...
	public void addEvent() {
		...
		CalendarEvent event = calendar.addEvent(user.ADMIN, start, end, eventName, "Public","random Kommentar1");
	...
	public void addEventSeries() {
		...
		EventSeries eventSeries = calendar.addEventSeries(user.ADMIN, start, end, eventName, "Public", "weekly","random Kommentar1");
